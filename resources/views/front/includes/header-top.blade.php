                ...
                <div class="header-top-left col-lg-6 col-md-6 d-flex justify-content-start align-items-center">
                    @if (Auth::user())
                        ...
                        <div class="detail-call d-flex align-items-center justify-content-center">
                            {{-- <i class="icon-deal"></i> --}}
                            <i class="zmdi zmdi-account" style="font-size:20px ;color:#03a9f4;margin-left:4px"></i>
                            <p>{{ Auth::user()->name }} </p>
                        </div>
                    @endif()
                </div>
                <div class="col-lg-6 col-md-6 d-flex justify-content-end align-items-center header-top-right">
                    <div class="register-out">
                        @if (!Auth::user())
                            ...
                            <a class="{{ route('login') }}" href="{{ route('login') }}" rel="nofollow"
                                title="تسجيل الدخول إلى حسابك">Sign in</a>
                        @else
                            <a class="" href="{{ route('logout') }}" rel="nofollow"
                                title="تسجيل الخروج">Logout</a>
                        @endif
